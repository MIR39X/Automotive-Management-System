...
$requireAuth = true;
$base = '/ams_project'; // agar folder ka naam aur hai, to yahan change karo
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if (empty($errors)) {
    ...
    $stmt = $pdo->prepare("INSERT INTO service (name, base_cost, description) VALUES (?, ?, ?)");
    $stmt->execute([$name, $costValue, $description]);
...
<div class="service-hero">
  <div>
    <h2>Add Service</h2>
    <p>Configure a service type to use in job cards and billing.</p>
  </div>
